...
var parent = button.parentElement;
        parent.innerHTML = "Name: <input type='text' id='bigcatname' name='name'><br> Goal: <input type='number' id='bigcatgoal' name='goal'><br><br>" +
        "    <button id='save' class='saveButton' onclick='addBigCat(this)'><img src='resources/images/checkmark.png' height='15px'/></button>" +
        "    <button id='cancel' class='cancelButton' onclick='cancelBigCat(this)'><img src='resources/images/x.png' height='15px' /></button>";
}
